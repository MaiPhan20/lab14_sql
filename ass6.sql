...
INSERT INTO Publisher VALUES (11, N'Tri Thức', N'53 Nguyễn Dui'),
                             (12, N'Kim Đồng', N'Hà Nội'),
							 (13, N'Kim Dung', N'Trung Quốc'),
							 (14, N'Kim Tinh',N'Hệ Sao'),
							 (15, N'Kim Trục Lưu',N'Phim Cổ Trang ')
INSERT INTO Booklist VALUES (111, N'Khoa Họci'),
                            (112, N'Văn Học Dân Gian'),
							(113, N'Võ Học '),
							(114, N'Khoa Học Nasa'),
							(115, N'Võ Thuật Phim Ảnh')
INSERT INTo Books VALUES ('B001', N'Trí Tuệ D', '2010', 11, 1, 111, 79000, 100, 1),
                         ('C002', N'Dế Mèn p', '1941', 12,2, 112, 10000, 1000,1),
						 ('D003', N'Tiếu Ngạo ', '1958', 13,3,113, 250000, 1950, 4),
